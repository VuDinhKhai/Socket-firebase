...
#push Data
data={"name":"Khai","age":20,"address":["Nam truc","Nam Dinh"]}
#db.child("khai").child("khai1").child("khai2").push(data)
db.child("khai").child("khai1").child("khai2").child("khai's info").set(data)

# data={"age":12, "Address" : ["Nam Truc","Nam Dinh"]}
# db.child("Khai").set(data)
